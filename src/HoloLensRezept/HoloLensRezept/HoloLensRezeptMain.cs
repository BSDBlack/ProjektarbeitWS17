...
using HoloLensRezept.Common;
using System.Threading.Tasks;
using Windows.Foundation;
using System.Collections.Generic;

#if DRAW_SAMPLE_CONTENT
using HoloLensRezept.Content;
#endif
...
namespace HoloLensRezept
{
    ...
    /// </summary>
    internal class HoloLensRezeptMain : IDisposable
    {
        ...
        public HoloLensRezeptMain(DeviceResources deviceResources)
        {
